...
const ZH_TRANSLATIONS = {
    ...
    "exam.files.summary": "当前范围包含 {{total}} 个 Markdown 文件 · 已排除 {{excluded}} 个 · 实际参与 {{eligible}} 个",
    ...
    "settings.examSmartFiltering.desc": "开启后，考试模式会额外排除空白、占位、链接索引、任务清单和低正文量内容。普通问答不受影响。",
...
const EN_TRANSLATIONS: Record<TranslationKey, string> = {
    ...
    "exam.files.summary": "{{total}} Markdown files in scope · {{excluded}} excluded · {{eligible}} included",
    ...
    "settings.examSmartFiltering.desc": "Exclude empty notes, stubs, link indexes, task lists, and notes with too little body content from exam generation. Q&A is unaffected.",
