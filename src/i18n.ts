...
const ZH_TRANSLATIONS = {
    ...
    "learningMap.legend": "拖动空白区域可平移；滚动可缩放。箭头表示关系方向；此视图仅显示已确认和用户创建的关系。",
...
const EN_TRANSLATIONS: Record<TranslationKey, string> = {
    ...
    "learningMap.legend": "Drag empty space to pan; scroll to zoom. Arrows show relationship direction. This view only shows confirmed and user-created relationships.",
