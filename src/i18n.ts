...
const ZH_TRANSLATIONS = {
    ...
    "progress.capacity.warning": "本地图谱容量已达到预警值，自动语义同步已暂停。",
    "progress.capacity.preferred": "此知识库建议使用可选的本地 Knowledge Engine。",
    "progress.capacity.required": "此知识库规模下，本地语义重建已暂停；已有事实仍可读取。",
    ...
    "learningMap.capacityWarning": "此知识库已达到本地语义图谱预警容量。自动同步已暂停，但仍可手动重建。",
    "learningMap.capacityPaused": "此知识库超过本地语义图谱容量。已有已确认事实仍可查看，但新的本地语义重建已暂停。",
    ...
    "conceptReview.capacityWarning": "此知识库已达到本地语义图谱预警容量。自动同步已暂停，仍可手动重建。",
    "conceptReview.capacityPaused": "此知识库超过本地语义图谱容量。已有概念事实仍可读取，但新的本地语义重建已暂停，直到缩小知识范围或使用外部图谱服务。",
...
const EN_TRANSLATIONS: Record<TranslationKey, string> = {
    ...
    "progress.capacity.warning": "Local graph capacity warning: automatic semantic sync is paused.",
    "progress.capacity.preferred": "This vault would benefit from an optional local Knowledge Engine.",
    "progress.capacity.required": "Local semantic rebuilds are paused at this vault size; existing facts remain readable.",
    ...
    "learningMap.capacityWarning": "Local semantic graph capacity warning: automatic sync is paused, but an explicit rebuild remains available.",
    "learningMap.capacityPaused": "New local semantic rebuilds are paused for this vault size. Existing confirmed facts remain available.",
    ...
    "conceptReview.capacityWarning": "This vault has reached the local semantic graph warning budget. Automatic semantic sync is paused; an explicit rebuild remains available.",
    "conceptReview.capacityPaused": "This vault exceeds the local semantic graph budget. Existing concept facts remain readable, but new local semantic rebuilds are paused until the knowledge scope is reduced or an external graph service is available.",
