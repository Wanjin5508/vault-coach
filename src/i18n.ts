...
const ZH_TRANSLATIONS = {
    ...
    "learningMap.summary": "{{nodes}} 个节点 · {{relationships}} 条关系 · 仅显示已确认事实",
    ...
    "learningMap.empty": "没有已确认概念符合当前学习图谱查询。待确认和已拒绝候选不会显示。",
    ...
    "learningMap.legend": "拖动空白区域可平移，拖动节点可调整布局，滚动可缩放。箭头表示关系方向；此视图仅显示已确认和用户创建的关系。",
    "learningMap.inspector": "检查器",
    "learningMap.select": "选择一个已确认概念或关系，以查看其方向和来源证据。",
    ...
    "learningMap.confidence": "{{origin}} · 置信度 {{confidence}}%",
...
const EN_TRANSLATIONS: Record<TranslationKey, string> = {
    ...
    "learningMap.summary": "{{nodes}} nodes · {{relationships}} relationships · confirmed facts only",
    ...
    "learningMap.search": "Search confirmed concepts",
    ...
    "learningMap.empty": "No confirmed concepts match this learning graph query. Pending and rejected candidates are intentionally excluded.",
    ...
    "learningMap.legend": "Drag empty space to pan, drag a node to adjust the layout, and scroll to zoom. Arrows show relationship direction. This view only shows confirmed and user-created relationships.",
    "learningMap.inspector": "Inspector",
    "learningMap.select": "Select a confirmed concept or relationship to inspect its direction and source evidence.",
    ...
    "learningMap.confidence": "{{origin}} · {{confidence}}% confidence",
